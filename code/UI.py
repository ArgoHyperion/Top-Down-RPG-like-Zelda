...
class UI:
    def __init__(self):
        ...
        #bar setup
        self.HPBarRect = pygame.Rect(10,10,HP_BAR_WIDTH,BAR_HEIGHT)
        self.MPBarRect = pygame.Rect(10,34,MP_BAR_WIDTH,BAR_HEIGHT)
    ...
    def showExp(self,exp):
        textSurface = self.font.render(str(int(exp)),False,TEXT_COLOR)
        x = self.displaySurface.get_size()[0]//2-20
